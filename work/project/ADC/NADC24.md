...
* 对比: AD7190, 4K, PGA=128; ![对比](image-6.png)
* 8K: PGA=128; ![配置1](image-3.png)![测试1](image-2.png)
* 2K: PGA=128; ![配置2](image-4.png)![测试2](image-5.png)

## 与AD7190对比

* 压力传感器量程：30KG，1.4976mV/V，精度0.05% -> 3.744mV
* NADC24: PGA=128, 4000sps
  * 1    + 16/2 = 9;           ![0KG](image-7.png)
  * 1049 + 18/2 = 1058;     ![5KG](image-11.png)
  * 2053 + 38/2 = 2072;     ![10KG](image-8.png)
  * 2072 - 9 = 2063;
* AD7190: PGA=128, 4800sps
  * -11 +   3/2 = -9.5;       ![0KG](image-10.png)
  * 1024 +  4/2 = 1026;      ![5KG](image-12.png)
  * 2077.5 + 25/2 = 2090;   ![10kg](image-9.png)
  * 2090 - (-9.5) = 2099.5;
* 理论采样值计算
  * ADC参考电压2.5V, PGA=128, 量程: 19.53mV
  * 10KG(满量程30KG) -> 3.744mV / 3 = 1.248mV
  * 1.248mV / 19.53mV * 2^15 = 2093.93
  * 33940-32768=1172
  * (x-32768)/32768*19.53mV/3.744mV*30=y(KG)
* 信噪比
  * 20*log(2^15/16) = 66.226 db
  * 20*log(2^15/3) = 80.767 db
* NADC24
  * 1.9799mV/V*2.5V = 4.94975mV
  * 15KG: 4.94975mV*15/500 = 0.1484925mV
  * 0.1484925mV/19.53mV * 2^15 = 127,562.25
  * 采集板：单极性值（150）分辨率24位
  * 上位机：双极性值（300）分辨率23位
  * 
